...
{
    public SkillCasterManage skillCaster_Manage;
    public InGameDataManage inGameData_Manage;
    public DamageLogManage damageLog_Manage;
    public ScriptableObjectManage so_Manage;
    ...
    public void Over()
    {
        ...
        InputManage.DisableInputAction<TouchControls>();
